...
On typical use case, you'd type `curl yourdomain.net/dotmanendpoint | bash -` in your terminal to show ineteractive menu, where you choose which dotfiles you want to install. You choose by selecting packages (folders) one by one or by configurable tags.
