...
printf "  \e[32m%s\e[0m)\e[35m %-15s\e[0m\n" "t" "list available package tags"
printf "  \e[32m%s\e[0m)\e[35m %-15s\e[0m\n" "u" "update installed dotfiles"
printf "  \e[32m%s\e[0m)\e[35m %-15s\e[0m\n" "c" "change dotfile install method (git symlinks or file copies)"
printf "  \e[32m%s\e[0m)\e[35m %-15s\e[0m\n" "s" "make dotman pull changes from repository"
printf "  \e[32m%s\e[0m)\e[35m %-15s\e[0m\n" "e" "enable dotfile auto update (requires cron)"
printf "  \e[32m%s\e[0m)\e[35m %-15s\e[0m\n" "d" "disable dotfile auto update"
printf "  \e[32m%s\e[0m)\e[35m %-15s\e[0m\n" "q" "exit program"
barPrint
SECRET="{{.ClientSecret}}"
